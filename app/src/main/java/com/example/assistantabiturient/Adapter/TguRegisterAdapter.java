...
public class TguRegisterAdapter extends RecyclerView.Adapter<TguRegisterAdapter.ViewHolder> {
    private static LayoutInflater inflater;
    private static Context context = App.getAppContext();

    public static List<FacultiesTusur> facultiesTusurList;
    public static Boolean[] checkBoxes = new Boolean[context.getResources().getInteger(R.integer.number_of_directions_TGU)];
    public TguRegisterAdapter(List<FacultiesTusur> facultiesTusurList) {
    ...
    @NonNull
    @Override
    public TguRegisterAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TguRegisterAdapter.ViewHolder viewHolder = new TguRegisterAdapter.ViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final TguRegisterAdapter.ViewHolder holder, final int position) {
