...
public class TpuRegisterAdapter extends RecyclerView.Adapter<TpuRegisterAdapter.ViewHolder>{
    private static LayoutInflater inflater;
    private static Context context = App.getAppContext();

    public static List<FacultiesTusur> facultiesTusurList;
    public static Boolean[] checkBoxes = new Boolean[context.getResources().getInteger(R.integer.number_of_directions_TPU)];
    public TpuRegisterAdapter(List<FacultiesTusur> facultiesTusurList) {
    ...
    @NonNull
    @Override
    public TpuRegisterAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TpuRegisterAdapter.ViewHolder viewHolder = new TpuRegisterAdapter.ViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final TpuRegisterAdapter.ViewHolder holder, final int position) {
